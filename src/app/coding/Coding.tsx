...
export default function Coding() {
  if (typeof document !== 'undefined') {
    ...
    const rightSide = resizer && (resizer.nextElementSibling as HTMLElement)
    const leftSide = resizer && (resizer.previousElementSibling as HTMLElement)
  ...
  return (
    <div className=' mx-4 mt-16'>
      <div className='flex h-screen'>
        ...
        <div className='border-gray-800 cursor-col-resize w-1' id='dragMe'></div>
